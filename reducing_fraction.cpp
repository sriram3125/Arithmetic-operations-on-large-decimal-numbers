...
void list::additem(char d) // added a new node in front of the list
{
	...
	if (tail == NULL)  // the first instance where the head and tail separate out
	{
		tail = newnode;
	}
...
void quotient(list l1,list l2,list &q){
	q.addend('0');
...
void gcd(list l1,list l2,list &g){
	node *temp1 = l1.topnode();
	node *temp2 = l2.topnode();
