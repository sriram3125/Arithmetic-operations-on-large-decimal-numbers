...
void subtraction(list l1,list l2,list &l3){ // subtract two numbers which are
...
int main(){
	...
	if(temp1->data != '-' && temp2->data == '-'){
		...
		if(wholenumber == '0'){
			if(compare_deci(l1,l2) == '<'){
				subtraction(l2,l1,l3);
				l3.additem('-');
			}
			else if(compare_deci(l1,l2) == '>'){
